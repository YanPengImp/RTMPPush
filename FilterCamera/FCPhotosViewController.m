...
@interface FCPhotosViewController ()
...
@implementation FCPhotosViewController
...
- (void)initViews {
    ...
    [selectButton setTitle:@"选取照片" forState:UIControlStateNormal];
...
- (void)selectButtonAction {
    [[FCImagePicker sharedInstance] showImagePickerWithDelegate:self complete:^(UIImage *image) {
